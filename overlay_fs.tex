...
# sh -c "echo '/dev/mmcblk0p3 /home ext4 defaults,noatime 0 2' >> ${ROOTDIR}/etc/fstab"
\end{lstlisting}
\FloatBarrier
\vspace{-5mm}
...
If the steps have been properly made up to this point, the customized image
...
our current considered system, we do this manually for each card. Insert
a memory card in your machine. It will be available as \texttt{/dev/mmcblkX}
or \texttt{/dev/sdX}.
