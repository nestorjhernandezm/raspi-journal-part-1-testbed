...
\Author{Chres W. S{\o}rensen $^{1,\dagger}$*, N\'estor J. Hern\'andez Marcano $^{1,2,\dagger}$, Juan A. Cabrera G. $^{3,4}$, Daniel E. Lucani $^{1,\dagger}$ and Frank H. P. Fitzek $^{3}$}
...
$^{3}$ \quad Technische Universit\"at Dresden, Deutsche Telekom Chair of Communication Networks. Dresden, Germany; \{juan.cabrera, frank.fitzek\}@tu-dresden.de\\
