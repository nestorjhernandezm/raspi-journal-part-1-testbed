...
\Author{Chres W. S{\o}rensen $^{1,\dagger}$*, N\'estor J. Hern\'andez Marcano $^{1,2,\dagger}$, \textcolor{red}{Juan A. Cabrera G. $^{3,4}$,} Daniel E. Lucani $^{1,\dagger}$ and Frank H. P. Fitzek $^{3}$}
% Authors, for metadata in PDF
\AuthorNames{Chres W. Soerensen, Nestor J. Hernandez M., Juan Cabrera, Daniel E. Lucani and Frank H. P. Fitzek}
% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Aalborg University, Department of Electronic Systems. Aalborg, Denmark; \{nh, cws, del\}@es.aau.dk\\
$^{2}$ \quad Steinwurf ApS. Aalborg, Denmark; nestor@steinwurf.com\\
$^{3}$ \quad Technische Universit\"at Dresden, Deutsche Telekom Chair of Communication Networks. Dresden, Germany; \{\textcolor{red}{juan.cabrera,} frank.fitzek\}@tu-dresden.de\\
\textcolor{red}{$^{4}$ \quad SFB 912 -- Collaborative Research Center HAEC. Dresden, Germany}}
...
\abstract{
  %Deploying a large-scale and configurable testbed for
  ...
  %not only the devices to run the same \ac{OS}, but also
  ...
  %networking and storage, and present the processing
...
Danish Council for Independent Research (Det Frie Forskningsr\r{a}d)\textcolor{red}{, and
