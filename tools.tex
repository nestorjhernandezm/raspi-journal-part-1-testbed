...
\texttt{fab <FUNCTION>:arg1,arg2,...}. Some executions from the terminal
...
\ac{SSH} to: (i) Login to a \ac{Raspi}, (ii) open a screen session, (iii)
...
\subsubsection{Setup toolchain on PC}
